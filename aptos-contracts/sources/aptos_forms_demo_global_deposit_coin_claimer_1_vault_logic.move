module aptos_forms_demo::aptos_forms_demo_global_deposit_coin_claimer_1_vault_logic {
    ...
    ): aptos_forms_demo_global::Coin_claimer_1_VaultDeposited {
        assert!(aptos_framework::coin::balance<aptos_framework::aptos_coin::AptosCoin>(std::signer::address_of(account)) > amount, 1);
    ...
    public(friend) fun mutate(
        _account: &signer,
        coin_claimer_1_vault_deposited: &aptos_forms_demo_global::Coin_claimer_1_VaultDeposited,
        aptos_forms_demo_global: aptos_forms_demo_global::AptosFormsDemoGlobal,
