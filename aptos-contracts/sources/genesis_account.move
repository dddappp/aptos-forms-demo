...
module aptos_forms_demo::genesis_account {
    use aptos_forms_demo::resource_account;
    ...
    public fun assert_genesis_account(account: &signer) {
        assert!(signer::address_of(account) == @aptos_forms_demo, error::invalid_argument(ENOT_GENESIS_ACCOUNT));
    }
