module aptos_forms_demo::aptos_forms_demo_coin_claimer_1_claim_logic {
    ...
    public(friend) fun verify(
        ...
        let claimed_count = aptos_forms_demo::aptos_forms_demo_global::coin_claimer_1_claimed_count(_global);
        assert!(total_shares > claimed_count, EAllSharesClaimed);
        let remaining_shares = total_shares - claimed_count;
        let remaining_amount = aptos_framework::coin::value(aptos_forms_demo::aptos_forms_demo_global::borrow_coin_claimer_1_vault(_global));
