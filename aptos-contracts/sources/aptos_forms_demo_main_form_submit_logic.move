module aptos_forms_demo::aptos_forms_demo_main_form_submit_logic {
    ...
    public(friend) fun mutate(
        ...
        let aptos_forms_demo_fr_duif = aptos_forms_demo_main_form_submitted::aptos_forms_demo_fr_duif(aptos_forms_demo_main_form_submitted);
        let aptos_forms_demo_fr_6i34 = aptos_forms_demo_main_form_submitted::aptos_forms_demo_fr_6i34(aptos_forms_demo_main_form_submitted);
        let fr_8xjs = aptos_forms_demo_main_form_submitted::fr_8xjs(aptos_forms_demo_main_form_submitted);
        let aptos_forms_demo_fr_9c3f = aptos_forms_demo_main_form_submitted::aptos_forms_demo_fr_9c3f(aptos_forms_demo_main_form_submitted);
        ...
        let aptos_forms_demo_fr_gh3o = aptos_forms_demo_main_form_submitted::aptos_forms_demo_fr_gh3o(aptos_forms_demo_main_form_submitted);
        let aptos_forms_demo_fr_fbba = aptos_forms_demo_main_form_submitted::aptos_forms_demo_fr_fbba(aptos_forms_demo_main_form_submitted);
