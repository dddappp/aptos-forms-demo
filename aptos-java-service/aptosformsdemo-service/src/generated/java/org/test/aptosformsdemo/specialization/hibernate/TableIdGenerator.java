package org.test.aptosformsdemo.specialization.hibernate;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.test.aptosformsdemo.tool.hibernate.Hello";
