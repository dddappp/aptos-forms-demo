...
public class HibernateFormIdRegistrationStateQueryRepository implements FormIdRegistrationStateQueryRepository {
    ...
    public FormIdRegistrationState get(Long id) {
        ...
        FormIdRegistrationState state = (FormIdRegistrationState)getCurrentSession().get(AbstractFormIdRegistrationState.SimpleFormIdRegistrationState.class, id);
        return state;
    }

    @Transactional(readOnly = true)
    public Iterable<FormIdRegistrationState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(FormIdRegistrationState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<FormIdRegistrationState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(FormIdRegistrationState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public FormIdRegistrationState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
