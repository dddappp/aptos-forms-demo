...
import org.test.aptosformsdemo.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.aptosformsdemo.*"); //add annotation mappings
