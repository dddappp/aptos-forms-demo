...
/**
 * Implementation of the AptosFormsDemoGlobal.WithdrawCoin_claimer_1_Vault command logic.
 */
@Component
public class WithdrawCoin_claimer_1_VaultLogic implements IWithdrawCoin_claimer_1_VaultLogic {
    /**
     * Verifies the AptosFormsDemoGlobal.WithdrawCoin_claimer_1_Vault command by performing validation logic
     * before the state mutation. Creates and returns an event.
     * 
     * @param eventFactory The supplier that creates new AptosFormsDemoGlobalEvent.Coin_claimer_1_VaultWithdrawn events
     ...
     */
    public AptosFormsDemoGlobalEvent.Coin_claimer_1_VaultWithdrawn verify(java.util.function.Supplier<AptosFormsDemoGlobalEvent.Coin_claimer_1_VaultWithdrawn> eventFactory, AptosFormsDemoGlobalState aptosFormsDemoGlobalState, BigInteger amount, VerificationContext verificationContext) {
        AptosFormsDemoGlobalEvent.Coin_claimer_1_VaultWithdrawn e = eventFactory.get();
        // TODO: implement
        return e;
    }

    /**
     * Performs the state mutation operation of AptosFormsDemoGlobal.WithdrawCoin_claimer_1_Vault command.
