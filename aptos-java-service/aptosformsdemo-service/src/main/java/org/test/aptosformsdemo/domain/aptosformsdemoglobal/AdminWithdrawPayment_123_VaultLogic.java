...
/**
 * Implementation of the AptosFormsDemoGlobal.AdminWithdrawPayment_123_Vault command logic.
 */
@Component
public class AdminWithdrawPayment_123_VaultLogic implements IAdminWithdrawPayment_123_VaultLogic {
    /**
     * Verifies the AptosFormsDemoGlobal.AdminWithdrawPayment_123_Vault command by performing validation logic
     * before the state mutation. Creates and returns an event.
     * 
     * @param eventFactory The supplier that creates new AptosFormsDemoGlobalEvent.Payment_123_VaultAdminWithdrawn events
     ...
     */
    public AptosFormsDemoGlobalEvent.Payment_123_VaultAdminWithdrawn verify(java.util.function.Supplier<AptosFormsDemoGlobalEvent.Payment_123_VaultAdminWithdrawn> eventFactory, AptosFormsDemoGlobalState aptosFormsDemoGlobalState, BigInteger amount, VerificationContext verificationContext) {
        AptosFormsDemoGlobalEvent.Payment_123_VaultAdminWithdrawn e = eventFactory.get();
        // TODO: implement
        return e;
    }

    /**
     * Performs the state mutation operation of AptosFormsDemoGlobal.AdminWithdrawPayment_123_Vault command.
