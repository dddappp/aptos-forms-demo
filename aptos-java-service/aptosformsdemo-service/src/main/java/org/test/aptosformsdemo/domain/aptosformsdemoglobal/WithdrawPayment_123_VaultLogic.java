...
/**
 * Implementation of the AptosFormsDemoGlobal.WithdrawPayment_123_Vault command logic.
 */
@Component
public class WithdrawPayment_123_VaultLogic implements IWithdrawPayment_123_VaultLogic {
    /**
     * Verifies the AptosFormsDemoGlobal.WithdrawPayment_123_Vault command by performing validation logic
     * before the state mutation. Creates and returns an event.
     * 
     * @param eventFactory The supplier that creates new AptosFormsDemoGlobalEvent.Payment_123_VaultWithdrawn events
     ...
     */
    public AptosFormsDemoGlobalEvent.Payment_123_VaultWithdrawn verify(java.util.function.Supplier<AptosFormsDemoGlobalEvent.Payment_123_VaultWithdrawn> eventFactory, AptosFormsDemoGlobalState aptosFormsDemoGlobalState, BigInteger amount, VerificationContext verificationContext) {
        AptosFormsDemoGlobalEvent.Payment_123_VaultWithdrawn e = eventFactory.get();
        // TODO: implement
        return e;
    }

    /**
     * Performs the state mutation operation of AptosFormsDemoGlobal.WithdrawPayment_123_Vault command.
