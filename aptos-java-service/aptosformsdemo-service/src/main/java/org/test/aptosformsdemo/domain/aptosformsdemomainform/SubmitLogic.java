...
/**
 * Implementation of the AptosFormsDemoMainForm.Submit command logic.
 */
@Component
public class SubmitLogic implements ISubmitLogic {
    /**
     * Verifies the AptosFormsDemoMainForm.Submit command by performing validation logic
     * before the state mutation. Creates and returns an event.
     * 
     * @param eventFactory The supplier that creates new AptosFormsDemoMainFormEvent.AptosFormsDemoMainFormSubmitted events
